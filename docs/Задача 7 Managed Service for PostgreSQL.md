...
![[Pasted image 20250307142147.png]]
...
![[Pasted image 20250307143325.png]]
![[Pasted image 20250307143827.png]]
	2. Для подключения через psql можно использовать команду ниже, при подключении будет запрошен пароль выбранного пользователя
```bash
...
![[Pasted image 20250307144206.png]]
4. Указать название базы данных и её владельца. Если в кластере есть другая, заранее существующая база данных - можно выбрать её в качестве шаблона
5. Создать таблицу можно просто написав SQL запрос, в pgAdmin для этого есть `Query tool`
```SQL
...
![[Pasted image 20250307150814.png]]
2. Во вкладке `Базы данных` удалить нужную базу данных
![[Pasted image 20250307150854.png]]
3. Восстановить кластер из резервной копии ![[Pasted image 20250307151057.png]]![[Pasted image 20250307151149.png]]
4. Проверяеи наличие удаленной бд и таблицы
	1. В psql:
![[Pasted image 20250307153108.png]]
	2. В pgAdmin просто подключиться к заново созданному кластеру. Удаленная база данных будет в списке доступных. Найти таблицу можно с помощью инструмента `Search Objects` ![[Pasted image 20250307153342.png]]
...
![[Pasted image 20250307153720.png]]
...
4. Восстановить из созданного по расписанию backup'a(У него будет тип automated) и удалить бд как пункте выше![[Pasted image 20250307155633.png]]
	1. Подключаемся через psql и смотрим наличие нашей таблицы ![[Pasted image 20250307161125.png]]
	2. Ровно так-же проверяем её в pgAdmin
	![[Pasted image 20250307161306.png]]
...
![[Pasted image 20250310154243.png]]
